...
palette_8bit = [
    (0, 0, 0),  # Black (SYSTEM)
    (128, 0, 0),  # Maroon (SYSTEM)
    (0, 128, 0),  # Green (SYSTEM)
    (128, 128, 0),  # Olive (SYSTEM)
    (0, 0, 128),  # Navy (SYSTEM)
    (128, 0, 128),  # Purple (SYSTEM)
    (0, 128, 128),  # Teal (SYSTEM)
    (192, 192, 192),  # Silver (SYSTEM)
    (128, 128, 128),  # Grey (SYSTEM)
    (255, 0, 0),  # Red (SYSTEM)
    (0, 255, 0),  # Lime (SYSTEM)
    (255, 255, 0),  # Yellow (SYSTEM)
    (0, 0, 255),  # Blue (SYSTEM)
    (255, 0, 255),  # Fuchsia (SYSTEM)
    (0, 255, 255),  # Aqua (SYSTEM)
    (255, 255, 255),  # White (SYSTEM)
    (0, 0, 0),  # Grey0
    (0, 0, 95),  # NavyBlue
    (0, 0, 135),  # DarkBlue
    (0, 0, 175),  # Blue3
